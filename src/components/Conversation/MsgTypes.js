    ...
    <Stack direction="row" justifyContent={el.incoming ? "start" : "end"}>
      ...
      >
        ...
        <Stack spacing={2} >
          ...
          >
            <Image size={48} />
            <Typography variant="caption">Cool_runnings.png</Typography>
            <IconButton>
              <DownloadSimple />
            </IconButton>
          </Stack>
          <Typography
            variant="body2"
            sx={{
              color: el.incoming ? theme.palette.text
                : "#fff"
            }}
          >{el.message}
          </Typography>
      ...
      >
        <Stack spacing={2} >
          ...
          >
            ...
            />
            <Stack spacing={2}>
              <Typography variant="subtitle2">Welcome To Chirpsky Kite</Typography>
              <Typography
                variant="subtitle2"
  ...
  return (
    <Stack direction="row" justifyContent={el.incoming ? "start" : "end"}>
      ...
      <Dialog open={open} onClose={handleClose}>
        <DialogContent>
          <img src={el.img} alt={el.message} style={{ width: '100%', height: 'auto' }} />
        </DialogContent>
      </Dialog>
              {menu && <MessageOptions />}
